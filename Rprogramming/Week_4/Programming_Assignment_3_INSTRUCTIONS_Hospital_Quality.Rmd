...
# Programming Assigment 3: Quiz

## Questions

### Q1. What resilt is returned by the following code?
>best("SC", "heart attack")
...
### Q2. What result is returned by de following code?
>best("NY", "pneumonia")
...
### Q3. What result is returned by de following code?
>best("AK", "pneumonia")
...
### Q4. What result is returned by de following code?
>rankhospital("NC", "heart attack", "worst")
...
### Q5. What result is returned by de following code?
...
### 6. What result is returned by de following code?
...
### Q7. What result is returned by de following code?
...
### Q8. What result is returned by de following code?
>r <- rankall("heart attack",4)
>as.character(subset(r,state == "HI")$hospital)
...
### Q9. What result is returned by de following code?
...
as.character(subset(r,state == "NJ")$hospital)
```
### Q10. What result is returned by de following code?
